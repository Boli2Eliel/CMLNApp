...
class Activite(models.Model):
    extension = models.ForeignKey(Extension, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Extension")
    type = models.CharField(choices=ACTIVITE,default="Culte de célébration", max_length=120, verbose_name="Type d'activité")
    ...
    def total_offrandes(self):
        return (self.offrande) + (self.dime) + (self.premices)+ (self.action_grace)+ (self.achat_parcelle)+ (self.construction)+ (self.autres)